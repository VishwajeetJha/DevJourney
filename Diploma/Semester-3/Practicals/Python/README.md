...
- `3d.py`  : Calculate change in Quarters, Dimes, Nickels, and Pennies  
- `3e.py`  : Find maximum of three numbers using the ternary operator  
- `3f.py`  : Calculate the area and volume of a sphere  
...
- `5d.py`  : Display an ASCII character table  
...
- `6d.py`  : Remove duplicate values from a list  
- `6e.py`  : Generate a 4x4 matrix of 0s & 1s and find rows/columns with most 1s  
- `a3.2.py` : Demonstrating Dictionaries  
...
- `8d.py`  : Check if a number is prime  
- `8e.py`  : Compute GCD using Euclid’s Algorithm  
- `8f.py`  : Compute EMI and generate an amortization schedule for a loan  
- `PrA4.1.py` : Fibonacci sequence generation  
- `PrA4.2.py` : Greatest common divisor calculation  
- `PrA4.3.py` : Area of a circle calculation using a default argument  
...
- `9d.py`  : Display the ReLU (Rectified Linear Unit) function graph  
- `9e.py`  : Generate a histogram for student marks  
- `9f.py`  : Create a user-defined module for basic mathematical operations  
...
- `10d.py` : Check if two words are anagrams  
...
- `11d.py` : Censor four-letter words in a file  
- `11e.py` : Compute average word length & sentence length in a file  
- `11f.py` : Interleave characters from two different text files  
- `PrA51.py` : Writing content to two text files and reading from them  
- `PrA52.py` : String method demonstrations (`startswith`, `endswith`)  
...
- `n3.py` : Palindrome check  
- `new.py` : Score to Grade Conversion  
- `new2.py` : Number Pattern Printing  
- `new3.py` : Reverse Number Pattern Printing  
- `new4.py` : Switch case implementation using a dictionary  
- `tempCodeRunnerFile.py` : Simple calculator for basic arithmetic operations  
